"""OpenAI Responses adapter behind the provider-neutral ModelGateway."""
...
from alos.model_gateway.gateway import ModelGatewayError, ModelGatewayTimeoutError
...
_NON_COMPLETED_STATUSES = {
    "failed", "in_progress", "cancelled", "queued", "incomplete",
}
