  ...
  return (
    <>
      <header className="pageHeader">
        <div>
          <p className="eyebrow">AI Executive Operating Layer</p>
          <h1>Ringkasan Operasional</h1>
          <p>Pekerjaan, deadline, dan sinyal operasional berdasarkan data sistem saat ini.</p>
        </div>
        <button className="button secondary" onClick={() => void loadDashboard()} type="button">Perbarui data</button>
      </header>
